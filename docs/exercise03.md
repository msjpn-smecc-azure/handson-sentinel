...
1. スケジュール済みクエリルールの作成
    ...
    1. ルールのロジックを設定
        ...
        - 「クエリ結果の表示 (View query results)」を選択して、現在のクエリ動作確認ができることを確認
        - クエリのスケジュール設定を変更し、結果シミュレーションの「現在のデータでテストする (Test with current data)」を選択することで

        ![](../images/ex03/0104b.png)
    ...
    1. インシデントの設定
        ...
        ![](../images/ex03/0104c.png)

    1. 自動応答

        デフォルトまま

        ![](../images/ex03/0104d.png)

    1. 確認と作成

        「保存」を選択

        ![](../images/ex03/0104e.png)
...
1. データ収集がすでに行われているか確認
    ...
    1. [調査と対応]-[追及]-[高度な追及] (または、左メニュー「高度な追求」）  を開く

        ![](../images/ex03/0401.png)
    ...
    1. スケジュール済みクエリルールの作成
        ...
        1. ルールのロジックを設定
            ...
            - エンティティ マッピング
                ...
                ![](../images/ex03/0406c.png)

            - アラートの詳細

                - アラート名の形式: `Malicious Inbox Rule - {{UserId__s}}`
                - アラートの説明の形式: `ユーザー {{UserId__s}} に対する不審な受信トレイルール作成を検出`

                ![](../images/ex03/0406d.png)
            ...
            - クエリのスケジュール設定
                ...
                ![](../images/ex03/0406e.png)
            
            - アラートスレッショルド

                - `より大きい (Is greater than)`: `0`

                ![](../images/ex03/0406f.png)
...
1. 「資産」タブへ移動、「ユーザー」にある `AdeleV@contoso.OnMicrosoft.com` を選択
